                        ...
                        <div class="replay">
                            ...
                            <form class="col-md-5">
                                <div class="form-group">
                                    <textarea class="form-control" id="CommentArea" placeholder="Comment..." rows="5"></textarea>
                                </div>
                        ...
                        <div class="comments">
                            ...
                            <div class="comments-body">
                                ...
                                <div class="comment col-lg-9 d-flex">
                                    ...
                                    <p class="col-lg-10 col-12">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                        Facere excepturi molestias fugiat impedit itaque, iure incidunt!</p>
                                </div>
                            </div>
